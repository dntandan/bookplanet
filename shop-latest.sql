...
--
-- Host: localhost
-- Generation Time: Nov 22, 2019 at 12:29 PM
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `shipping`
  MODIFY `sid` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
